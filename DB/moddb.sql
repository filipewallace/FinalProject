...
INSERT INTO `game` (`id`, `name`, `multiplayer`, `description`, `img_url`, `platform_id`, `developer_id`, `publisher_id`, `esrb_rating_id`) VALUES (13, 'Garden Paws', 1, 'Canadian game about garden paws in Canada. Use different paws to make your mark in the garden. Fun, eh?', 'https://staticdelivery.nexusmods.com/Images/games/4_3/tile_2680.jpg', 1, 1, 1, 1);
...
INSERT INTO `game` (`id`, `name`, `multiplayer`, `description`, `img_url`, `platform_id`, `developer_id`, `publisher_id`, `esrb_rating_id`) VALUES (15, 'SnowRunner', 1, 'A big truck has to drive in the snow to deliver massive pipes to a small town in Saskatchewan. A real nail biter.', 'https://staticdelivery.nexusmods.com/Images/games/4_3/tile_3245.jpg', 1, 1, 1, 1);
INSERT INTO `game` (`id`, `name`, `multiplayer`, `description`, `img_url`, `platform_id`, `developer_id`, `publisher_id`, `esrb_rating_id`) VALUES (16, 'Super Chicken Jumper', 0, 'This chicken is a real super jumper. Jumps over buildings. Jumps over trees. Jumps over rivers and mountains.', 'https://staticdelivery.nexusmods.com/Images/games/4_3/tile_4062.jpg', 1, 1, 1, 1);
...
INSERT INTO `game` (`id`, `name`, `multiplayer`, `description`, `img_url`, `platform_id`, `developer_id`, `publisher_id`, `esrb_rating_id`) VALUES (19, 'Petz 5', 0, 'A game about pets. This is the perfect game for anyone who wants pets but just not real pets that cost money.', 'https://staticdelivery.nexusmods.com/Images/games/4_3/tile_3178.jpg', 1, 1, 1, 1);
INSERT INTO `game` (`id`, `name`, `multiplayer`, `description`, `img_url`, `platform_id`, `developer_id`, `publisher_id`, `esrb_rating_id`) VALUES (20, 'Farming Simulator 22', 1, 'A game that simulates farming on a small farm in Idaho where farmers farm potatoes to feed the population.', 'https://staticdelivery.nexusmods.com/Images/games/4_3/tile_4163.jpg', 1, 1, 1, 1);
